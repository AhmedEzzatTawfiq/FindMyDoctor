                    ...
                    <div className='flex flex-col gap-6 md:max-w-lg'>
                        ...
                        <div className='flex items-center gap-4 mt-2 flex-wrap'>
                            <button
                                ...
                                className='bg-white text-indigo-700 font-semibold px-6 py-2.5 rounded-full border border-white/30 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-2'
                            >
                                Browse Doctors
